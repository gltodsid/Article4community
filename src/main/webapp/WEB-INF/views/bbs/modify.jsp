    	...
    	<main id="main" class="dFlex">
    		...
    		<div id="contents" class="mod">
				...
				<form name="modifyFrm" action="/modifyProc"
					...
					<h2>${sessionScope.sessionMap.subject}</h2>
						
					<table id="modTbl">
						<tbody id="modTblBody">
							<tr>
								<td class="req">작성자</td>
								<td>${sessionScope.sessionMap.uName}</td>
							</tr>
							<tr>
								<td class="req">제목</td>
								<td>
									<input type="text" name="subject" value="${sessionScope.sessionMap.subject}"
										size="50" id="subject">
								</td>
							</tr>
							<tr>
								...
								<td>
									<textarea name="content" id="txtArea"  cols="89" wrap="hard">${sessionScope.sessionMap.content}</textarea>
								</td>
							</tr>			
						</tbody>
